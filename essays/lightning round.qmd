...
1.  If Anagha Sikha doesn't earn an A in this class, then no one should because from what I've seen, she has put much of her effort into each of the labs and assignments, asking questions in the class discord, revising all her assignments that needed revisions, and making the effort to go to office hours even just for clarification on things.
...
4.  The part that surprised me the most was making beautiful graphs by writing code *and* the many available customization options you can include to improve them; I didn't know that stuff like that could be done in R/Rstudio before this class.
